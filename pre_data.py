        ...
        with open(path, 'r', encoding='utf-8') as file:
            for line in file:
                ...
                for word in jieba.lcut(line.strip()):
                    ...
                    words_ids = self.Tokenizer.convert_tokens_to_ids(tokens)
                    text_ids.append(words_ids)
                input_lis, label_lis, label_position = self.id_to_mask(text_ids)
                output.append((input_lis, label_lis, label_position))
        return output
